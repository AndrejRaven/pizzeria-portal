    ...
    return (
        <div>
            ...
            <div className={classes.root}>
                <List className={classes.list} aria-label="table1" key='1'>
                    <Typography
                        align='center'
                        className={classes.header}>
                        Table 1
                        ...
                        (order.table == '1' && order.status != 'delivered') ? (
                            <div className={classes.order}>
                                <ListItem key={order.id}>
                                    <Link  key={order.id} className={classes.link} to={`${process.env.PUBLIC_URL}/order/${order.id}`} >Total: {order.price}, id: {order.id}, date: {order.date}</Link>
                                </ListItem>
                ...
                <List className={classes.list} aria-label="table2" key='2'>
                    <Typography
                        align='center'
                        className={classes.header}>
                        Table 2
                ...
                <List className={classes.list} aria-label="table3" key='3'>
                    <Typography
                        align='center'
                        className={classes.header}>
                        Table 3
